...
<section class="p-6 flex justify-center items-center min-h-screen bg-gray-100">
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Login bij MiniCMS</h2>
        ...
        <form method="post" action="<?= ADMIN_BASE_PATH ?>/login" class="space-y-4">
            <!-- CSRF Token -->
            ...
            <div>
                <button class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-200" type="submit">
                    Inloggen
                </button>
            </div>
        </form>
        ...
        <div class="relative my-6">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-white text-gray-500">Of ga verder met</span>
            </div>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-600">
            <p>Nog geen account? <a href="<?= ADMIN_BASE_PATH ?>/register" class="text-blue-600 hover:underline font-medium">Registreren</a></p>
        </div>
